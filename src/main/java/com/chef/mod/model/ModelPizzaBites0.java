...
extends ModelBase {
    ...
    public ModelPizzaBites0() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.Base = new ModelRenderer((ModelBase)this, 0, 0);
        this.Base.addBox(0.0f, 0.0f, 0.0f, 14, 1, 14);
        this.Base.setRotationPoint(-7.0f, 23.0f, -7.0f);
        this.Base.setTextureSize(64, 32);
        this.Base.mirror = true;
        this.setRotation(this.Base, 0.0f, 0.0f, 0.0f);
        this.Border1 = new ModelRenderer((ModelBase)this, 13, 0);
        this.Border1.addBox(0.0f, 0.0f, 0.0f, 1, 1, 14);
        this.Border1.setRotationPoint(6.0f, 22.0f, -7.0f);
        ...
        this.Border3.addBox(0.0f, 0.0f, 0.0f, 12, 1, 1);
