...
public class ModelWaffleMakerWaffles2
extends ModelBase {
    ModelRenderer Base;
    ModelRenderer Base2;
    ...
    ModelRenderer Plate;
    ModelRenderer Waffle1;
    ModelRenderer Waffle2;

    public ModelWaffleMakerWaffles2() {
        ...
        this.Waffle1 = new ModelRenderer((ModelBase)this, 0, 2);
        this.Waffle1.addBox(0.0f, 0.0f, 0.0f, 5, 1, 9);
        this.Waffle1.setRotationPoint(-6.0f, 8.0f, -5.0f);
        this.Waffle1.setTextureSize(64, 32);
        this.Waffle1.mirror = true;
        this.setRotation(this.Waffle1, 0.0f, 0.0f, 0.0f);
        this.Waffle2 = new ModelRenderer((ModelBase)this, 36, 2);
