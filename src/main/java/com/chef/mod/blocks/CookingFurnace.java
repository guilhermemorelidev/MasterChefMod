...
extends BlockContainer {
    ...
    public CookingFurnace(boolean isBurning) {
        super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister.registerIcon("chef:cooking_furnace_side");
        this.iconFront = this.isBurning ? iconRegister.registerIcon("chef:cooking_furnace_front_on") : iconRegister.registerIcon("chef:cooking_furnace_front_off");
        this.iconTop = iconRegister.registerIcon("chef:cooking_furnace_top");
    }
    ...
    public Item getItemDropped(int i, Random random, int j) {
        return Item.getItemFromBlock((Block)MyBlocks.cooking_furnace);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
        if (!world.isRemote) {
            FMLNetworkHandler.openGui((EntityPlayer)player, (Object)Chef.instance, (int)0, (World)world, (int)x, (int)y, (int)z);
        }
        return true;
    }
    ...
    public static void updateBlockState(boolean isBurning, World worldObj, int xCoord, int yCoord, int zCoord) {
        ...
        keepInventory = true;
        if (isBurning) {
            worldObj.setBlock(xCoord, yCoord, zCoord, MyBlocks.cooking_furnace_on);
        } else {
            worldObj.setBlock(xCoord, yCoord, zCoord, MyBlocks.cooking_furnace);
        }
        keepInventory = false;
    ...
    public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
        TileEntityCookingFurnace tileentity;
        if (!keepInventory && (tileentity = (TileEntityCookingFurnace)world.getTileEntity(x, y, z)) != null) {
