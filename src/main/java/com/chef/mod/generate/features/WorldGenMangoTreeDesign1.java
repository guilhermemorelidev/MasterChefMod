...
public class WorldGenMangoTreeDesign1
extends WorldGenAbstractTree {
    private final int minTreeHeight;
    private final Block log;
    private final Block leaves;

    public WorldGenMangoTreeDesign1(int minTreeHeight, Block log, Block leaves) {
        super(false);
        ...
        if (y >= 1 && y + l + 1 <= 256) {
            ...
            if (isSoil && y < 256 - l - 1) {
                ...
                for (k1 = 0; k1 < l; ++k1) {
                    ...
                    this.buildBlock(worldIn, x, y + k1, z, this.log, 1);
                }
                return true;
            }
            return false;
